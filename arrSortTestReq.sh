...
# AWS Host
curl -o video.mp4 -X GET http://ec2-13-57-239-150.us-west-1.compute.amazonaws.com:80/getfile -H "Content-Type: application/json" -H "Accept: application/json" -d '{"file": "/app/output/20230503-201235.mp4"}'
